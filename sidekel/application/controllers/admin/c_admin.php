...
class C_admin extends CI_Controller {
    ...
    {	
		...
		//////////////////////////////////////////////////////
		$data['jurnalisme'] = $this->m_jurnalisme->total_jurnalisme();		
		$data['ped'] = $this->m_ped->total_ped();		
		$data['regulasi'] = $this->m_regulasi->total_regulasi();		
		//$data['kontak'] = $this->m_kontak->total_kontak();		
