    ...
    function load_data() {	
		...
		foreach ($records['records']->result() as $row)
		{
			...
			$record_items[] = array(
                ...
                $row->judul_regulasi,
				$row->isi_regulasi,
				str_replace('uploads/files/','',$row->file_regulasi),
//				'<input type="button" value="Edit" class="ubah" onclick="edit_regulasi(\''.$row->id_regulasi.'\')"/>'
	...
	function simpan_regulasi() {
		...
		//$this->form_validation->set_rules('file_regulasi', 'File Regulasi', 'required');
		...
		{		
			...
			{   
				...
				$this->session->set_flashdata('exist', 'Gagal ! Tipe file tidak mendukung !');					
