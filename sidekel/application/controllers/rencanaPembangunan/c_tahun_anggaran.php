...
class C_tahun_anggaran extends CI_Controller {
	...
	function getTahun(){	
			...
			$data['tahun'] = $this->m_tahun_anggaran->get_tahun_dynamic($id_periode);
			$this->load->view('rencanaPembangunan/tahun_anggaran/tahun',$data);
	}
    ...
    function edit($id){
		...
		if($this->session->userdata('logged_in') AND $role == 'Perencana Pembangunan')
		{
			$data['hasil'] = $this->m_tahun_anggaran->getTahunAnggaranById($id);
			$data['id_periode_selected'] = $data['hasil']->id_periode;
			$id_periode = $data['id_periode_selected'];
			$data['tahun'] = $this->m_tahun_anggaran->get_tahun_dynamic($id_periode);
	...
	function update_tahun_anggaran() {	
		...
		$id_periode = $this->input->post('id_periode', TRUE);
			$data = array(
		  	...
		  	$result = $this->m_tahun_anggaran->updateTahunAnggaran(array('id_tahun_anggaran' => $id_tahun_anggaran), $data);
		  	redirect('rencanaPembangunan/c_tahun_anggaran','refresh');
    }
	...
	function delete()    {
        ...
        foreach($post as $id){
            $this->m_tahun_anggaran->deleteTahunAnggaran($id);
            $sucess++;
        }
