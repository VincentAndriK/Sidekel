...
class C_smart extends CI_Controller {
	...
	function load_data()
	{
		...
		if($this->input->post('tempat_lahir', TRUE) != NULL)
		{
			$arrInput[$countArr]  = array(
			'tempat_lahir',
		...
		if($this->input->post('id_goldar', TRUE) != NULL)
		{
			$arrInput[$countArr]  = array(
			'id_goldar',
		...
		if($this->input->post('id_kewarganegaraan', TRUE) != NULL)
		{
			$arrInput[$countArr]  =array( 
			'id_kewarganegaraan',
		...
		if($this->input->post('id_pendidikan', TRUE) != NULL)
		{
			$arrInput[$countArr]  = array(
			'id_pendidikan',
		...
		if($this->input->post('id_agama', TRUE) != NULL)
		{
			$arrInput[$countArr]  =array( 
			 'id_agama',
		...
		if($this->input->post('id_pekerjaan', TRUE) != NULL)
		{
			$arrInput[$countArr]  = array(
			'id_pekerjaan',
		...
		if($this->input->post('id_status_kawin', TRUE) != NULL)
		{
			$arrInput[$countArr]  = array(
			 'id_status_kawin',
		...
		if($this->input->post('id_status_penduduk', TRUE) != NULL)
		{
			$arrInput[$countArr]  = array(
			'id_status_penduduk',
		...
		if($this->input->post('id_status_tinggal', TRUE) != NULL)
		{
			$arrInput[$countArr]  = array(
			'id_status_tinggal',
		...
		if($this->input->post('id_difabilitas', TRUE) != NULL)
		{
			$arrInput[$countArr]  = array(
			'id_difabilitas',
		...
		if($this->input->post('is_bsm', TRUE) != NULL)
		{
			$arrInput[$countArr]  = array(
			'is_bsm',
		...
		if($this->input->post('is_raskin', TRUE) != NULL)
		{
			$arrInput[$countArr]  = array(
			'is_raskin',
		...
		if($this->input->post('is_jamkesmas', TRUE) != NULL)
		{
			$arrInput[$countArr]  = array(
			'is_jamkesmas',
		...
		if($this->input->post('is_pkh', TRUE) != NULL)
		{
			$arrInput[$countArr]  = array(
			'is_pkh',
		...
		if($this->input->post('id_kelas_sosial', TRUE) != NULL)
		{
			$arrInput[$countArr]  = array(
			'id_kelas_sosial',
		...
		//redirect('smart/c_smart/', 'refresh');   
