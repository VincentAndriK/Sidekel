        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-4">
                <div class="centered panel " style="text-align:center;">
                    ...
                    <div class="panel-heading" style="background-color:#22313F">
						<img src="<?php echo base_url(); ?>assetku/img/logo_sidekel.png" style="height:75px; width:auto; text-align:center;"> 						
                    </div>
