...
class M_demografi extends CI_Model {
  ...
  function __construct(){
	...
	{	
		$this->db->select('tbl_demografi.*,tbl_pengguna.nama_pengguna as nama_pengguna')->from($this->_table);
		$this->db->join('tbl_pengguna','tbl_demografi.id_pengguna = tbl_pengguna.id_pengguna ');
		$this->db->where('tbl_demografi.id_demografi', $id);
