...
class M_visimisi extends CI_Model {
  ...
  function __construct(){
	...
	{	
		$this->db->select('tbl_visi_misi.*,tbl_pengguna.nama_pengguna as nama_pengguna')->from($this->_table);
		$this->db->join('tbl_pengguna','tbl_visi_misi.id_pengguna = tbl_pengguna.id_pengguna ');
		$this->db->where('tbl_visi_misi.id_visi_misi', $id);
