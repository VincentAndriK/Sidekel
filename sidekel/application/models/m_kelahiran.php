...
class M_kelahiran extends CI_Model {
  ...
  function __construct()
  {
	...
	public function get_kelahiran_flexigrid()
    {
		...
		$this->db->join('tbl_surat','tbl_surat.id_surat=tbl_kelahiran.id_surat', 'left');
		$this->db->join('ref_pelapor','ref_pelapor.id_pelapor=tbl_kelahiran.id_pelapor', 'left');
		$this->db->join('ref_jen_kel','ref_jen_kel.id_jen_kel = tbl_kelahiran.id_jen_kel', 'left');
