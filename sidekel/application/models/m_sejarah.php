...
class M_sejarah extends CI_Model {
  ...
  function __construct(){
	...
	{	
		$this->db->select('tbl_sejarah.*,tbl_pengguna.nama_pengguna as nama_pengguna')->from($this->_table);
		$this->db->join('tbl_pengguna','tbl_sejarah.id_pengguna = tbl_pengguna.id_pengguna ');
		$this->db->where('tbl_sejarah.id_sejarah', $id);
