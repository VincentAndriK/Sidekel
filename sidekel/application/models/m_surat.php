...
class M_surat extends CI_Model {
  ...
  function __construct()
  {
	...
	public function get_surat_flexigrid()
	{
		...
		$this->db->join('ref_kode_surat','ref_kode_surat.kode_surat=tbl_surat.kode_surat', 'left');
		$this->db->join('tbl_perangkat','tbl_perangkat.id_perangkat= tbl_surat.id_perangkat', 'left');
