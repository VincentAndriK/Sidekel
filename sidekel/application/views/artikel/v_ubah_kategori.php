...
<?php echo form_open('admin/c_artikel/update_kategori'); ?>
<fieldset>
	<legend></legend>
	<!-- Text input-->

	<input  value="<?= $hasil->id_kategori_artikel?>" id="id_kategori_artikel" name="id_kategori_artikel" type="hidden" class="form-control input-md">
