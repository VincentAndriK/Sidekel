...
<?php echo form_open('admin/c_artikel/simpan_artikel'); ?>
<fieldset>
<legend></legend>
<input type="hidden" name="id_pengguna" id="id_pengguna" value="<?= $hasil->id_pengguna ?>" size="20" /> 
	...
	<div class="form-group">
        ...
        <div class="col-md-10">         
         <?php $id = 'id="id_kategori_artikel" class="form-control input-md" required';
				echo form_dropdown('id_kategori_artikel',$kategori,'',$id)?>
	...
	<div class="form-group"> 
        ...
        <div class="col-md-10">
        <input class="form-control input-md"  type="text" name="judul" id="judul" placeholder="Judul Artikel"/>
...
<legend></legend>	
<div class="form-group"> 
	<label class="col-md-2 control-label" for="isi">Artikel</label>
	 <div class="col-md-10">
	 
	 <!--textarea class="form-control input-md" id="xxx" name="isi" placeholder="Describe yourself here..." ></textarea-->
	 <textarea class="form-control input-md" id="summernote" name="isi" placeholder="Describe yourself here..." ></textarea>
	<span class="help-block"></span>
	</div>
</div>
<legend></legend>
