...
<legend></legend>
	...
	<div class="form-group">
    	 <label class="col-md-3 control-label" for="path_css">Tema Website</label> 
         <div class="col-md-9"> 
	...
	<div class="form-group"> 	
		...
		<input class="form-control input-md"  type="file" name="logo_desa" id="imgInp" multiple>
         <span class="help-block">
			<div align="left">Gambar harus bertipe .png</div>
		</span>
	...
	<div class="form-group"> 
		<div class="image-editor ">	
			<label class="col-md-3 control-label" for="">Logo Kabupaten</label>
			<div class="col-md-9">
			
			<input type="file" id="userfile" class="cropit-image-input custom form-control input-md" accept="image/*">
