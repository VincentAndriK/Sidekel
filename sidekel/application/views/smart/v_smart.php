...
$('form').submit(function() {
	...
	var a1 = document.getElementById("id_jen_kel").value;
	var a2 = document.getElementById("tempat_lahir").value;
	var a3 = document.getElementById("id_goldar").value;
	var a4 = document.getElementById("id_kewarganegaraan").value;
	var a5 = document.getElementById("id_pendidikan").value;
	var a6 = document.getElementById("id_agama").value;
	var a7 = document.getElementById("id_pekerjaan").value;
	var a8 = document.getElementById("id_status_kawin").value;
	var a9 = document.getElementById("id_status_penduduk").value;
	var a10 = document.getElementById("id_status_tinggal").value;
	var a11 = document.getElementById("id_difabilitas").value;
	var a12 = document.getElementById("is_bsm").value;
	var a13 = document.getElementById("is_raskin").value;
	var a14 = document.getElementById("is_jamkesmas").value;
	var a15 = document.getElementById("is_pkh").value;
	var a16 = document.getElementById("id_kelas_sosial").value;
