...
<?php echo form_open_multipart('admin/c_regulasi/update_regulasi'); ?>
<legend></legend>
<input type="hidden" name="id_regulasi" id="id_regulasi" value="<?= $hasil->id_regulasi?>" readonly = "readonly"/>
    <div class="form-group">
    	 <label  class="col-md-3 control-label" for="judul_regulasi">Judul Regulasi </label>
        <div class="col-md-9">
         <span class="help-block">
         <input class="form-control input-md" type="text" name="judul_regulasi" id="judul_regulasi" value="<?= $hasil->judul_regulasi?>" required/> 
	...
	<div class="form-group">
        ...
        <div class="col-md-9">
         <span class="help-block">
		 <textarea class="form-control input-md" rows="5" name="isi_regulasi" id="isi_regulasi" required> <?=$hasil->isi_regulasi?></textarea>
