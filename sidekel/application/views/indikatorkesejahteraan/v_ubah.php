...
<?php echo form_open('indikatorkesejahteraan/c_indikator_kesejahteraan/update_indikator_kesejahteraan'); ?>
...
<fieldset>
	...
	<div class="form-group">
		<div class="col-md-9">
			<input  value="<?= $hasil->id_indikator?>" id="id_indikator" name="id_indikator" type="hidden" placeholder="id" class="form-control input-md">
			<span class="help-block"><?php echo form_error('id_indikator', '<p class="field_error">','</p>')?></span>  
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-md-9">
			<input   value="<?= $hasil->bobot?>" id="bobot" name="bobot" type="text" 
