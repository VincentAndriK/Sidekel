   ...
   <div class="form-group">
	...
	<div class="form-group">
		...
		<div id="datepicker" class="input-group date" >
				...
				<input placeholder="Tgl-Bln-Thn" type="text" value="<?= date('d-m-Y', strtotime($result->tanggal_lahir))?>" name="tanggal_lahir" id="ttl" class="form-control input-md" readonly="readonly">
			</div>
		<span class="help-block">
        </span>
