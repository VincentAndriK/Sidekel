...
<input class="form-control input-md" type="hidden" name="id_spp" id="id_spp" value="<?= $spp1->id_spp ?>" /> 
<input class="form-control input-md" type="hidden" name="id_lpj" id="id_lpj" value="<?= $lpj->id_lpj ?>" /> 
	<legend></legend>
