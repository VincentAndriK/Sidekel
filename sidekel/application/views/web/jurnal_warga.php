...
<legend><h1>Jurnalisme Warga</h1></legend>
<?php $flashmessage = $this->session->flashdata('exist');
	echo ! empty($flashmessage) ? '<p class="message">' . $flashmessage . '</p>': ''; ?>


<?php  $attributes = array('id' => 'formJurnal'); 
echo form_open('web/c_jurnal_warga/', $attributes); ?>

<div class="panel panel-success">
	<div class="panel-body">
		<div class="form-group has-success"> 
			<label class="col-md-2 control-label" for="">Judul Berita<label style="color:red;">*</label></label>
		...
		<div class="form-group has-success"> 
			<label class="col-md-2 control-label" for="">Penulis Berita<label style="color:red;">*</label></label>
			<div class="col-md-10 col-sm-12 col-xs-12">
		...
		<div class="form-group has-success"> 
			...
			<label class="col-md-2 control-label" for="">Gambar Berita<label style="color:red;">*</label></label>
				<div class="col-md-10">
					<div id="lihat">
		...
		<div class="form-group has-success"> 
			<label class="col-md-2 control-label" for="">Isi Berita<label style="color:red;">*</label></label>
			<div class="col-md-10">
		...
		<div class="form-group has-success"> 
			<label class="col-md-2 col-sm-4 col-xs-12 control-label" for="">Kode Verifikasi<label style="color:red;">*</label></label>
			<div class="col-md-3 col-sm-4 col-xs-5">
			<input class="form-control input-md pull-right" type="text" autocomplete="off" name="userCaptcha" placeholder="Masukan Kode" value="<?php if(!empty($userCaptcha)){ echo $userCaptcha;} ?>" required/>
			<span class="help-block"></span>		
			</div>
			<label for="captcha" class=""><?php echo $captcha['image']; ?></label>
		</div>
	</div>
	...
	<div class="panel-footer">
			<input type="submit" class="btn btn-success" value="Kirim" id="kirimJurnal" style=""/>
...
$('form').submit(function() {
 ...
 function nav_active(){
	document.getElementById("nav-berita").className = "active";
}
...
$(document).ready(function() {
  ...
  <?php $flashmessage = $this->session->flashdata('message');
	...
	<?php $flashmessage = $this->session->flashdata('error');
		echo ! empty($flashmessage) ? 'alertify.error("'.$flashmessage.'")' : ''; ?>
});
</script>
