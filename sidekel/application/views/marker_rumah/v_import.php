...
<?php echo form_open_multipart('indikatorkesejahteraan/c_marker_rumah/import_excel/'); ?>
...
<input type="button" class="btn btn-danger" value="Batal" id="batal" onclick="location.href='<?= base_url() ?>indikatorkesejahteraan/c_marker_rumah'"/>
</div>
<?php echo form_close();?>
