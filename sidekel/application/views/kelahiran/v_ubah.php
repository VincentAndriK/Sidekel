		...
		<span class="help-block">
			...
			<div id="datepicker" class="input-group date" >
				<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
					<input placeholder="Tgl-Bln-Thn" type="text" value="<?= date('d-m-Y', strtotime($hasil->tgl_kelahiran))?>" name="tgl_kelahiran" id="tgl_kelahiran" class="form-control input-md" readonly>
			</div>
