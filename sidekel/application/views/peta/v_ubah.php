...
?>
	...
	<div class="form-group"> 	
        ...
        <div class="col-md-10">
			<textarea name="embed" placeholder="Salin kode embed disini" class="form-control" rows="5" required>
			<?php echo $peta;?>
			</textarea>
         <span class="help-block">
			<div align="right">Salin kode embed dari <a style="color:#005;" href="https://www.google.com/maps/d/" target="_blank">google maps</a>, untuk memperbarui peta</div>
		</span>
		</div>
	</div>	
