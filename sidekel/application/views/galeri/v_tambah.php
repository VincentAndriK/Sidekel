...
echo form_open_multipart('admin/c_galeri/simpan_galeri',$attributes); ?>
	<fieldset>
		<!-- Form Name -->
		<legend></legend>
		...
		<div class="form-group">
		  <label class="col-md-3 control-label" for="kategori">Pilih Kategori Galeri</label>  
		  <div class="col-md-9">
            <select id="kategori" class="form-control">
                <option>-----Kategori Galeri-----</option>
                <option>Foto</option>
                <option>Video</option>
            </select>
		...
		<div id="label-judul" class="form-group">
			...
			<div class="col-md-9">
				<input id="judul" class="form-control" placeholder="Judul Konten" type="text" name="judul" value="">
				<span class="help-block"></span>
			</div>
		</div>
		...
		<div id="gambar" class="form-group">
			...
			<div class="col-md-9">
				<input id="url-video" class="form-control" placeholder="URL" type="text" name="url-video" value="">
				<span class="help-block"></span>
			</div>
		</div>
...
$('.image-editor').cropit({
  imageState: {
	src: '<?php echo site_url('uploads/galeri/no-thumb.png');?>'
  }
});
  });
...
$(document).ready(function() {
  ...
  $("#kategori").change(function(){          
    var value = $("#kategori option:selected").val();
    if(value == "-----Kategori Galeri-----"){
    	$('#gambar').hide();
    	$('#video').hide();
    	$('#label-judul').hide();
    	document.getElementById("simpan").disabled = true;
    ...
    $('form').submit(function() {
	 ...
	 if($("#kategori option:selected").val()=="Foto"){
