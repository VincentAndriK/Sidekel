			...
			<div class="col-md-9">
			 <span class="help-block">
				...
				<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
					<input placeholder="Tgl-Bln-Thn" type="text" value="<?= date('d-m-Y', strtotime($hasil->tgl_meninggal))?>" name="tgl_meninggal" id="tgl_meninggal" size="50" class="form-control input-md" readonly>
			</div>
