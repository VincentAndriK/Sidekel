...
<legend></legend>
	...
	<div class="form-group">
			 ...
			 <div class="col-md-9">			 
			 <input type="text" class="form-control" name="nikKK" id="nikKK" size="50" placeholder="Nik Kepala Keluarga / Nama (min 2 karakter)" required/> 
			<span class="help-block"></span>
		</div>
		</div>
		<legend></legend>
		<div class="form-group">
			 ...
			 <div class="col-md-9">			 
				<input type="text" class="form-control" name="nik" id="nik" size="50" readonly="readonly" placeholder="NIK Pengelola (Kepala Keluarga)" required/>
