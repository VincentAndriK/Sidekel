...
echo form_open_multipart('indikatorkesejahteraan/c_sensus/simpan_data_sensus', $attributes); 
?>
<fieldset>
<legend></legend>
	...
	<div class="form-group">
		 ...
		 <div class="col-md-9">
			<div id="datepicker" class="input-group date" >
				...
				<input placeholder="Tgl-Bln-Thn" type="text" name="tanggal_sensus" id="tanggal_sensus" class="form-control input-md" readonly="readonly">
			</div>
