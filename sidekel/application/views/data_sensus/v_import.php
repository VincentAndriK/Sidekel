...
<?php echo form_open_multipart('indikatorkesejahteraan/c_pertanyaan_sensus/import_excel/'); ?>
<div class="form-group">
	<input type="file" id="file_upload" class="" name="userfile" size="20" />
	<span class="help-block">Format berkas harus .xls</span> 
	<span class="help-block">Pilihan Jawaban Maksimal 5</span> 
	</div>
</br>
<div>
<input type="submit" class="btn btn-success" value="Unggah" id="submit-btn-file" />
<input type="button" class="btn btn-danger" value="Batal" id="batal" onclick="location.href='<?= base_url() ?>indikatorkesejahteraan/c_pertanyaan_sensus'"/>
</div>
<?php echo form_close();?>
