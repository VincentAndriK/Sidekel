...
<legend></legend>
	...
	<div class="form-group"> 	
        ...
        <div class="col-md-9">
         <span class="help-block">
			<input class="form-control input-md"  type="url" name="url" id="url" placeholder="http://" />
		</span>
		</div>
	</div>		
	<legend></legend>
	<div class="form-group"> 	
        ...
        <div class="col-md-9">
         <span class="help-block">
			<input class="form-control input-md"  type="file" name="konten_background" id="imgInp" accept="image/jpeg" required>
			<input class="form-control input-md"  type="hidden" name="path_konten_background" id="path_konten_background">
			<input class="form-control input-md"  type="hidden" name="old_background" id="old_background">
	...
	<div class="form-group"> 	
        ...
        <div class="col-md-9">
         <span class="help-block">
			<input class="form-control input-md"  type="file" name="konten_logo" id="imgInp1" accept="image/jpeg, image/png" required>
...
var _base_url = '<?= base_url() ?>';
	...
	document.querySelector('#imgInp').addEventListener('change', function (event) {
		...
		var upload = function (photo, callback) {
			...
			request.open('POST', _base_url + 'admin/c_slider_beranda/resize_upload_background?old=' + oldName);
			...
			(function () {
				...
				resize.photo(files[i], 888, 'file', function (resizedFile) {
					...
					upload(resizedFile, function (response) {
						...
						document.getElementById('old_background').value=response.nama;
   ...
   if (window.File && window.FileReader && window.FileList && window.Blob)
	{
		...
		if( !$('#imgInp1').val()) //check empty input filed
		{
			alertify.error("Silahkan Pilih Konten Logo !");
			return false
		}
