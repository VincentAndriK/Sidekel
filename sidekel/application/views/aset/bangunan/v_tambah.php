...
<!-- Form Name -->
	...
	<div class="form-group">
	  ...
	  <div class="col-md-9">
	  <input id="pencarian" name="pencarian" type="text" placeholder="No Sertifikat Tanah / Deskripsi Tanah" class="form-control input-md" required>
	...
	<div class="form-group">
		...
		<div class="col-md-9">
			<div id="datepicker" class="input-group date" >
				...
				<input placeholder="Tgl-Bln-Thn" type="text" value="" name="tgl_bangun" id="tgl_bangun" class="form-control input-md" readonly="readonly">
			</div>
