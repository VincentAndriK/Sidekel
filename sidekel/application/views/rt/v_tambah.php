...
<legend></legend>
    ...
    <div class="form-group">
        ...
        <div class="col-md-9"> 
			<div class="input-group">
				<input class="form-control input-md" type="text" name="luas_wilayah" id="luas_wilayah" placeholder="Luas Wilayah (ha)"/> 
	...
	<div class="form-group">
    	 <label  class="col-md-3 control-label" for="nama_rw">RW </label>
        <div class="col-md-9">
		<?php $id = 'id="id_rw_sementara" class="form-control input-md required"';
				echo form_dropdown('id_rw_sementara',array('--Pilih Dusun dahulu--'),'',$id)?>
			<div id="lala"></div>
         <span class="help-block">		 
				<?php echo form_error('id_rw', '<p class="field_error">','</p>')?>
		</span>
		</div>		
	</div>
