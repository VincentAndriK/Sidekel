                    ...
                    <ul class="nav" id="side-menu">
						...
						<div id="pengelola_data_web" class="collapse">
							<ul id="" class="nav nav-pills nav-stacked nav-second-level ">
								...
								<li id="nav-sosmed" class="">
									<a href="<?php echo site_url('admin/c_sosmed/');?>">Media Sosial</a>
								</li>
								<li id="nav-galeri" class="">
									<a href="<?php echo site_url('admin/c_galeri/');?>">Galeri Web</a>
								</li>
								<li id="nav-artikel" class="">
									<a href="<?php echo site_url('admin/c_artikel/');?>">Artikel</a>
								</li>
							</ul>
						</div>
						</li>
