...
<legend></legend>
   ...
   <div class="form-group">
        ...
        <div class="col-md-9">
         <span class="help-block">
         <input class="form-control input-md" type="text" name="nik" value="" size="30" id="nik" required /> </span>
		</div>
	</div>
   <div class="form-group">
	...
	<div class="form-group">
        ...
        <div class="col-md-4">
			...
			<div id="datepicker" class="input-group date" >
				...
				<input placeholder="Tgl-Bln-Thn" type="text" value="" name="tanggal_lahir" id="ttl" class="form-control input-md" size="20" readonly="readonly">
			</div>
									  ...
									  <!--<a href="javascript:NewCssCal('tgl_hpl','ddmmyyyy')">
										 <div class="input-group">
											...
											<div id="datepicker2" class="input-group date" >
												<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
												<input placeholder="Tgl-Bln-Thn" type="text" value="" name="tanggal_lahir" id="ttl" class="form-control input-md" readonly="readonly">
											</div>
