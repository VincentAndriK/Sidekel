   ...
   <div class="form-group">
	...
	<div class="form-group">
		...
		<div id="datepicker" class="input-group date" >
			...
			<input placeholder="Tgl-Bln-Thn" type="text" value="<?= date('d-m-Y', strtotime($penduduk->tanggal_lahir))?>" name="tanggal_lahir" id="ttl" class="form-control input-md" readonly="readonly">
		</div></div>
									...
									<div class="form-group">
									  ...
									  <!--<a href="javascript:NewCssCal('tgl_hpl','ddmmyyyy')">
										 <div class="input-group">
											...
											<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
											<input placeholder="Tgl-Bln-Thn" type="text" value="" name="tgl_hpl" id="tgl_hpl" class="form-control input-md" readonly>
										</div>
