	  ...
	  <div class="col-md-9">
		...
		<div id="datepicker" class="input-group date" >
				<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
					<input placeholder="Tgl-Bln-Thn" type="text" value="" name="tanggal_lahir" id="tanggal_lahir" class="form-control input-md" readonly>
			</div>
...
<legend></legend>
	...
	<div class="form-group">
		...
		<div id="datepicker2" class="input-group date" >
				<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
					<input placeholder="Tgl-Bln-Thn" type="text" value="" name="tanggal_pindah_masuk" id="tanggal_pindah_masuk" class="form-control input-md" readonly>
			</div>
