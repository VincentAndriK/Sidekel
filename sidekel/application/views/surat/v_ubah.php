...
<legend></legend>   
	...
	<div class="form-group">
		...
		<div id="datepicker" class="input-group date" >
				<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
					<input placeholder="Awal" type="text" value="<?= date('d-m-Y',strtotime($hasil->tgl_awal))?>" name="tgl_awal" id="tgl_awal" class="form-control input-md" readonly>
			</div>
	...
	<div class="form-group">
		...
		<div id="datepicker2" class="input-group date" >
				<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
					<input placeholder="Akhir" type="text" value="<?= date('d-m-Y',strtotime($hasil->tgl_akhir))?>" name="tgl_akhir" id="tgl_akhir" class="form-control input-md" readonly>
			</div>
