...
<!-- Text input-->
		...
		<legend></legend>
		<div class="form-group">
			 <label class="col-md-6 control-label" for="is_sementara_keluarga">Nomer Kartu Keluarga Tujuan</label>
			  <label class="col-md-6 control-label" for="is_sementara_keluarga">Nama Kepala Keluarga Tujuan</label>
			 <div class="col-md-6">			 
