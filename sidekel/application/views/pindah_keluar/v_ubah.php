        ...
        <span class="help-block">
			...
			<div id="datepicker" class="input-group date" >
				<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
					<input placeholder="Tgl-Bln-Thn" type="text" value="<?= date('d-m-Y', strtotime($pindah_keluar->tgl_pindah_keluar))?>" name="tanggal_pindah_keluar" id="tanggal_pindah_keluar" class="form-control input-md" readonly>
			</div>
